...
stk_path = pd.read_csv(r"E:\Project\Stock_Prediction\ui\public\TataMotors.csv")
...
model.save(f'TataMotors_model.h5')
model1 = load_model('TataMotors_model.h5')
